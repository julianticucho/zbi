...
if __name__ == "__main__":
    ...
    for n in nsims:
        for r in runs:
            s = sample_model(
                run_dir=run_dir, n_samples=n, 
                checkpoint=f"round_00000_{n}_mlpv2_{r}.pt"
            )
    ...
    for n in nsims:
        plot_ppc(
            ...
            legend_fontsize=30,
            output_path=f"plots/posteriors/planck_lite_r2_round_00000_{n}_mlpv2_(r1,r2,r3)_prior_limits.pdf"
        )
