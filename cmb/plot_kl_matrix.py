...
if __name__ == "__main__":
    ...
    checkpoints = [
        "round_00000_150000_mlpv2_r1.pt",
        "round_00000_150000_mlpv2_r2.pt",
        "round_00000_150000_mlpv2_r3.pt",
    ]
    ...
    fig, ax = plot_kl_matrix(
        k,
        output_path="plots/kl_matrix/round_00000_150000_mlpv2_(r1,r2,r3).pdf",
        sample_labels=["r1", "r2", "r3"],
        log_scale=False,
        annotate=True,
        annotate_fmt=".2g",
    ...
    checkpoints = [
        "round_00000_175000_mlpv2_r1.pt",
        "round_00000_175000_mlpv2_r2.pt",
        "round_00000_175000_mlpv2_r3.pt",
    ]
    ...
    fig, ax = plot_kl_matrix(
        k,
        output_path="plots/kl_matrix/round_00000_175000_mlpv2_(r1,r2,r3).pdf",
        sample_labels=["r1", "r2", "r3"],
        log_scale=False,
        annotate=True,
        annotate_fmt=".2g",
